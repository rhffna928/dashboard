...
public class GetUserInverterResponseDto extends ResponseDto{
    ...
    private GetUserInverterResponseDto(Inverter inverter) {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
        this.inverter = inverter;
    }
    public static ResponseEntity<GetUserInverterResponseDto> success(Inverter inverter){
        
        GetUserInverterResponseDto result =  new GetUserInverterResponseDto(inverter);
