...
@Getter
public class GetPlantList2ResponseDto extends ResponseDto{


    
    private final List<PlantSummary> plantList2;

    private GetPlantList2ResponseDto(List<PlantSummary> plantList2) {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
        this.plantList2 = plantList2;
    }

    public static ResponseEntity<GetPlantList2ResponseDto> success(List<PlantList2> plantList2){
        List<PlantSummary> list = plantList2.stream()
                                    .map(PlantSummary::fromEntity)
                                    .toList();
        GetPlantList2ResponseDto result =  new GetPlantList2ResponseDto(list);
