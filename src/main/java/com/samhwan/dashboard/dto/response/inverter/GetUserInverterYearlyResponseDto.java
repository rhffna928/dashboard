...
public class GetUserInverterYearlyResponseDto extends ResponseDto {
  ...
  private GetUserInverterYearlyResponseDto(List<InverterView> series) {
    super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    this.series = series;
  }

  public static ResponseEntity<GetUserInverterYearlyResponseDto> success(List<InverterView> series) {
    return ResponseEntity.status(HttpStatus.OK).body(new GetUserInverterYearlyResponseDto(series));
  }
